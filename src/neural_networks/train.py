...
def train_model_SLPLinear(model, train_loader, criterion, optimizer, scheduler, num_epochs):
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.title('SLP Linear Training Loss vs. Epochs')
    plt.legend()
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.title('SLP Linear Test Accuracy vs. Epochs')
    plt.legend()
    plt.show() # Renders the plot
...
def train_modelSLP(model, train_loader, criterion, optimizer, scheduler, num_epochs):
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.title('SLP Training Loss vs. Epochs')
    plt.legend()
    plt.show() # Renders the plot
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.title('SLP Test Accuracy vs. Epochs')
    plt.legend()
    plt.show() # Renders the plot
...
def evaluate(model, test_loader, labels_onehot, device='cpu'):       #
    ...
    if count == 30:
        ...
        plt.title("Digit R Confusion Matrix")
        plt.show()
        count = 0
        '''
    return test_acc
...
def train_modelMLP(model, train_loader, criterion, optimizer, scheduler, num_epochs):
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.title('MLP Test Accuracy vs. Epochs')
    plt.legend()
    plt.show() # Renders the plot
